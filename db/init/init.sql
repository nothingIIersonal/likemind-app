...
-- -----------------------------------------------------
-- Table `likemind`.`event_messages`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `likemind`.`event_messages` (
  `event_messages_id` INT NOT NULL AUTO_INCREMENT,
  `user_id` INT NOT NULL,
  `event_id` INT NOT NULL,
  ...
  PRIMARY KEY (`event_messages_id`),
  UNIQUE INDEX `event_messages_id_UNIQUE` (`event_messages_id` ASC) VISIBLE,
  INDEX `fk_event_messages_event_id_idx` (`event_id` ASC) VISIBLE,
  INDEX `fk_event_messages_user_id_idx` (`user_id` ASC) VISIBLE,
  CONSTRAINT `fk_event_messages_event_id`
    FOREIGN KEY (`event_id`)
    REFERENCES `likemind`.`events` (`event_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_event_messages_user_id`
    FOREIGN KEY (`user_id`)
    REFERENCES `likemind`.`users` (`user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `likemind`.`private_messages`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `likemind`.`private_messages` (
  `private_messages_id` INT NOT NULL AUTO_INCREMENT,
  ...
  `is_reply` TINYINT(1) NOT NULL DEFAULT 0,
  `reply_to_id` INT NULL,
  PRIMARY KEY (`private_messages_id`),
  UNIQUE INDEX `private_messages_id_UNIQUE` (`private_messages_id` ASC) VISIBLE,
  INDEX `fk_private_messages_recipient_id_idx` (`recipient_id` ASC) VISIBLE,
  INDEX `fk_private_messages_sender_id_idx` (`sender_id` ASC) VISIBLE,
  CONSTRAINT `fk_private_messages_sender_id`
    FOREIGN KEY (`sender_id`)
    REFERENCES `likemind`.`users` (`user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_private_messages_recipient_id`
...
START TRANSACTION;
USE `likemind`;
INSERT INTO `likemind`.`images` (`image_id`, `user_id`, `URN`, `created_at`, `is_deleted`) VALUES (1, 1, '/srv/img/0.jpg', '2024-01-15 12:24:02', 0);
INSERT INTO `likemind`.`images` (`image_id`, `user_id`, `URN`, `created_at`, `is_deleted`) VALUES (2, 3, '/srv/img/1.jpg', '2024-01-15 12:24:02', 0);
INSERT INTO `likemind`.`images` (`image_id`, `user_id`, `URN`, `created_at`, `is_deleted`) VALUES (3, 1, '/srv/img/2.jpg', '2024-01-15 12:24:02', 1);
INSERT INTO `likemind`.`images` (`image_id`, `user_id`, `URN`, `created_at`, `is_deleted`) VALUES (4, 6, '/srv/img/3.jpg', '2024-01-15 12:24:02', 0);

COMMIT;


-- -----------------------------------------------------
-- Data for table `likemind`.`event_messages`
-- -----------------------------------------------------
START TRANSACTION;
USE `likemind`;
INSERT INTO `likemind`.`event_messages` (`event_messages_id`, `user_id`, `event_id`, `message`, `time`, `is_deleted`, `is_reply`, `reply_to_id`) VALUES (1, 2, 1, 'Hello there', '2024-01-15 12:24:02', 0, 0, NULL);
INSERT INTO `likemind`.`event_messages` (`event_messages_id`, `user_id`, `event_id`, `message`, `time`, `is_deleted`, `is_reply`, `reply_to_id`) VALUES (2, 5, 1, 'Im leaving... Bye!', '2024-01-15 12:24:02', 0, 0, NULL);
INSERT INTO `likemind`.`event_messages` (`event_messages_id`, `user_id`, `event_id`, `message`, `time`, `is_deleted`, `is_reply`, `reply_to_id`) VALUES (3, 1, 1, 'Bye!', '2024-01-15 12:24:02', 0, 1, 2);
INSERT INTO `likemind`.`event_messages` (`event_messages_id`, `user_id`, `event_id`, `message`, `time`, `is_deleted`, `is_reply`, `reply_to_id`) VALUES (4, 5, 1, 'suckers', '2024-01-15 12:24:02', 1, 0, NULL);
INSERT INTO `likemind`.`event_messages` (`event_messages_id`, `user_id`, `event_id`, `message`, `time`, `is_deleted`, `is_reply`, `reply_to_id`) VALUES (5, 5, 2, 'Now Im there', '2024-01-15 12:24:02', 0, 0, NULL);
INSERT INTO `likemind`.`event_messages` (`event_messages_id`, `user_id`, `event_id`, `message`, `time`, `is_deleted`, `is_reply`, `reply_to_id`) VALUES (6, 4, 2, 'Yap! Where are you?', '2024-01-15 12:24:02', 0, 1, 5);

COMMIT;


-- -----------------------------------------------------
-- Data for table `likemind`.`private_messages`
-- -----------------------------------------------------
START TRANSACTION;
USE `likemind`;
INSERT INTO `likemind`.`private_messages` (`private_messages_id`, `sender_id`, `recipient_id`, `message`, `time`, `is_deleted`, `is_reply`, `reply_to_id`) VALUES (1, 1, 5, 'who are you calling a sucker, asshole?!', '2024-01-15 12:24:02', 0, 0, NULL);
INSERT INTO `likemind`.`private_messages` (`private_messages_id`, `sender_id`, `recipient_id`, `message`, `time`, `is_deleted`, `is_reply`, `reply_to_id`) VALUES (2, 2, 5, 'do you have extra teeth?', '2024-01-15 12:24:02', 0, 0, NULL);
INSERT INTO `likemind`.`private_messages` (`private_messages_id`, `sender_id`, `recipient_id`, `message`, `time`, `is_deleted`, `is_reply`, `reply_to_id`) VALUES (3, 3, 5, 'actually.. I will kill you', '2024-01-15 12:24:02', 0, 0, NULL);
INSERT INTO `likemind`.`private_messages` (`private_messages_id`, `sender_id`, `recipient_id`, `message`, `time`, `is_deleted`, `is_reply`, `reply_to_id`) VALUES (4, 5, 3, 'shutupmzfkr', '2024-01-15 12:24:02', 0, 1, 3);
INSERT INTO `likemind`.`private_messages` (`private_messages_id`, `sender_id`, `recipient_id`, `message`, `time`, `is_deleted`, `is_reply`, `reply_to_id`) VALUES (5, 3, 5, 'fuck you!', '2024-01-15 12:24:02', 1, 1, 4);
